...
KFH_windParamDefault = 0;
KFH_rainDensityParamDefault = 0;
KFH_timeOfDayParamDefault = 6;
KFH_timeMultiplierParamDefault = 1;
KFH_cloudCoverParamDefault = 18;
KFH_grassVisibilityParamDefault = 2;
KFH_enemySkillParamDefault = 100;
KFH_waveSizeScaleParamDefault = 100;
KFH_waveIntervalScaleParamDefault = 100;
KFH_specialThreatScaleParamDefault = 100;
KFH_pressureScaleParamDefault = 100;
KFH_enemyHardCapParamDefault = 50;
KFH_armedEnemyScaleParamDefault = 100;
KFH_vehicleThreatParamDefault = 1;
KFH_extractionTypeParamDefault = 0;
KFH_extractionMaxDistanceParamDefault = 0;
KFH_checkpointVehicleCountParamDefault = 2;
KFH_checkpointLateVehicleMaxParamDefault = 2;
KFH_startPatrolVehicleMaxParamDefault = 6;
KFH_finalArsenalCooldownParamDefault = 300;
KFH_civilianTrafficFrequencyParamDefault = 100;
KFH_enemyTrafficFrequencyParamDefault = 100;
...
KFH_checkpointEntryWaveGraceSeconds = 4;
...
KFH_envTrafficLoopSeconds = 22;
KFH_envTrafficMaxCivilianGroups = 24;
KFH_envTrafficMaxMilitaryGroups = 4;
...
KFH_envTrafficMilitaryChance = 0.32;
KFH_envTrafficMilitaryDelaySeconds = 75;
...
KFH_envMilitaryFootPatrolChance = 0.58;
KFH_envMilitaryFootPatrolMax = 4;
KFH_envMilitaryFootPatrolSizeMin = 4;
KFH_envMilitaryFootPatrolSizeMax = 5;
...
KFH_envMilitaryCheckpointChance = 0.55;
KFH_envMilitaryCheckpointMax = 3;
...
KFH_vehicleCasualtyPullHullClearance = 0.85;
KFH_vehicleCasualtyPullAnimation = "MedicOther";
...
KFH_leaperProxyPounceForwardVelocity = 3.2;
KFH_leaperProxyPounceUpVelocity = 0.25;
